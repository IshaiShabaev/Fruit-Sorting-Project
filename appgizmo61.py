...
def btnClickFunctionStart():
	...
	if os.path.isfile(fname) and stop_threads :
		file1 = open(fname, "r")
		coll = float(file1.read())
		print("collaboration " + str(coll))
		file1.close()
		hx.set_reference_unit(coll)
...
def btnCollaborate():
	...
	# hx.tare_B()
	try:
		#print("PUT WEIGHT WITHIN 5 SECONDS")
		# time.sleep(5)
		global hx
		val = hx.get_weight(5)
		coll = (val/1000) * 5
		print(coll)
		f = open("colWeight.txt", "w")
		f.write(str(coll))
		f.close()
...
def btnClickFunctionRest():
	...
	os.system("python3 appgizmo61.py")
...
# This is the section of code which creates a button
tk.Button(root, text='Collaborate', bg='#CDAA7D', font=('arial', 34, 'bold'), command=btnCollaborate).place(x=450, y=30)
# This is the section of code which creates a button
